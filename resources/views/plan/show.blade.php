    ...
    <div>
        <div class="border-b border-gray-200">
            <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                <a href="#" class="border-primary-500 text-primary-600 flex whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium" aria-current="page">
                    Features

                    <span class="bg-primary-100 text-primary-600 ml-3 hidden rounded-full py-0.5 px-2.5 text-xs font-medium md:inline-block">
                        {{ $plan->features_count }}
                    </span>
                </a>

                <!-- Current: "border-primary-500 text-primary-600", Default: "border-transparent text-gray-500 hover:border-gray-200 hover:text-gray-700" -->
                {{-- <a href="#" class="border-transparent text-gray-500 hover:border-gray-200 hover:text-gray-700 flex whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium">
                    ...
                    <!-- Current: "bg-primary-100 text-primary-600", Default: "bg-gray-100 text-gray-900" -->
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <form method="POST" action="{{ route('tithe.plans.attach-feature', $plan->id) }}" class="mt-5 sm:flex sm:items-center">
                    ...
                    <div class="w-full sm:max-w-xs">
                        ...
                        <select id="feature_id" name="feature_id" class="block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-primary-600 sm:text-sm sm:leading-6">
                    ...
                    <div class="w-full mt-3 sm:max-w-xs sm:mt-0 sm:ml-3 sm:w-auto">
                        ...
                        <div class="flex rounded-md shadow-sm">
                            ...
                            <input type="number" step="0.01" name="charges" id="charges" class="block w-full min-w-0 flex-1 rounded-none rounded-r-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6" placeholder="0.01">
                        </div>
                    ...
                    <button type="submit" class="mt-3 inline-flex w-full items-center justify-center rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600 sm:mt-0 sm:ml-3 sm:w-auto">Attach</button>
                </form>
            </div>
        </div>
        <div>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        <tr>
                            ...
                            <td class="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                ...
                                <button x-data @click="$store.planFeature.confirmDetachment({{ $feature->id }})" type="button" class="text-primary-600 hover:text-primary-900">Detach<span class="sr-only">, {{ $feature->name }}</span></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Are you sure you want to delete <span class="inline-flex items-center rounded-full bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800">{{ $plan->display_name ?? $plan->name }}</span> plan?
