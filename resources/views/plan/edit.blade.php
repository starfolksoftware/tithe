        ...
        <div>
            ...
            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="display_name" id="display_name" value="{{ $plan->display_name }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-600 sm:text-sm sm:leading-6">
                    </div>
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="relative mt-2 rounded-md shadow-sm">
                        ...
                        <input type="number" step="0.01" name="amount" id="amount" value="{{ $plan->amount }}" class="block w-full rounded-md border-0 py-1.5 pl-16 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-600 sm:text-sm sm:leading-6" placeholder="2500">
                    </div>
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-2">
                        <textarea id="description" name="description" rows="3" class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-600 sm:py-1.5 sm:text-sm sm:leading-6">{{ $plan->description }}</textarea>
                    </div>
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        ...
                        <select id="grace_days" name="grace_days" value="{{ $plan->grace_days }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-slate-600 sm:text-sm sm:leading-6">
