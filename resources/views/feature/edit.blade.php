            ...
            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <fieldset class="mt-6">
                        ...
                        <div class="mt-4 space-y-4">
                            <div class="flex items-center">
                                <input id="consumable-yes" name="consumable" type="radio" value="1" {{ old('consumable', $feature->consumable) == '1' ? 'checked' : '' }} class="h-4 w-4 border-gray-300 text-primary-600 focus:ring-primary-600">
                                <label for="consumable-yes" class="ml-3 block text-sm font-medium leading-6 text-gray-900">Yes</label>
                            </div>
                            <div class="flex items-center">
                                <input id="consumable-no" name="consumable" type="radio" value="0" {{ old('consumable', $feature->consumable) == '0' ? 'checked' : '' }} class="h-4 w-4 border-gray-300 text-primary-600 focus:ring-primary-600">
                ...
                <div class="sm:col-span-2">
                    <fieldset class="mt-6">
                        ...
                        <div class="mt-4 space-y-4">
                            <div class="flex items-center">
                                <input id="quota-yes" name="quota" type="radio" value="1" {{ $feature->quota == '1' ? 'checked' : '' }} class="h-4 w-4 border-gray-300 text-primary-600 focus:ring-primary-600">
                                <label for="quota-yes" class="ml-3 block text-sm font-medium leading-6 text-gray-900">Yes</label>
                            </div>
                            <div class="flex items-center">
                                <input id="quota-no" name="quota" type="radio" value="0" {{ $feature->quota == '0' ? 'checked' : '' }} class="h-4 w-4 border-gray-300 text-primary-600 focus:ring-primary-600">
                ...
                <div class="sm:col-span-2">
                    <fieldset class="mt-6">
                        ...
                        <div class="mt-4 space-y-4">
                            <div class="flex items-center">
                                <input id="postpaid-yes" name="postpaid" type="radio" value="1" {{ $feature->postpaid == '1' ? 'checked' : '' }} class="h-4 w-4 border-gray-300 text-primary-600 focus:ring-primary-600">
                                <label for="postpaid-yes" class="ml-3 block text-sm font-medium leading-6 text-gray-900">Yes</label>
                            </div>
                            <div class="flex items-center">
                                <input id="postpaid-no" name="postpaid" type="radio" value="0" {{ $feature->postpaid == '0' ? 'checked' : '' }} class="h-4 w-4 border-gray-300 text-primary-600 focus:ring-primary-600">
